 ...
 */
let numero = 17; // Altere este valor para testar outros números
if (numero % 2 === 0) {
 ...
 */
let idadePessoa = 16; // Altere este valor para testar diferentes idades
if (idadePessoa >= 18) {
...
let nota = 8; // Experimente alterar a nota (ex: 6) para ver o resultado.
let faltas = 12; // Experimente alterar o número de faltas (ex: 8) para ver o resultado.
if (nota >= 7 && faltas <= 10) {
 ...
 */
let base = 7; // Altere este valor para testar a tabuada de outro número.
for (let i = 1; i <= 10; i++) {
